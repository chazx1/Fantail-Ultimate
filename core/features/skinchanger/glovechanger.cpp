...
static auto get_wearable_create_fn() -> create_client_class_fn {
	...
	for (client_class = interfaces::client->get_client_classes();
		...
		if (client_class->class_id == class_ids::ceconwearable) {
	...
	if (config_system.item.glovechanger_enable) {
		...
		if (glove) {
			...
			case 0:
				break;
			case 1:
				apply_glove_skin(glove, GLOVE_STUDDED_BLOODHOUND, config_system.item.paint_kit_index_glove, index_blood, 3, gloves_wear);
				break;
			case 2:
				apply_glove_skin(glove, GLOVE_SPORTY, config_system.item.paint_kit_index_glove, index_sport, 3, gloves_wear);
				break;
			case 3:
				apply_glove_skin(glove, GLOVE_SLICK, config_system.item.paint_kit_index_glove, index_slick, 3, gloves_wear);
				break;
			case 4:
				apply_glove_skin(glove, GLOVE_LEATHER_WRAP, config_system.item.paint_kit_index_glove, index_leath, 3, gloves_wear);
				break;
			case 5:
				apply_glove_skin(glove, GLOVE_MOTORCYCLE, config_system.item.paint_kit_index_glove, index_moto, 3, gloves_wear);
				break;
			case 6:
				apply_glove_skin(glove, GLOVE_SPECIALIST, config_system.item.paint_kit_index_glove, index_speci, 3, gloves_wear);
				break;
			case 7:
				apply_glove_skin(glove, GLOVE_HYDRA, config_system.item.paint_kit_index_glove, index_hydra, 3, gloves_wear);
				break;
			}
